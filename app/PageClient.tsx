...
export default async function Page({
  ...
  return (
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <div className="mx-auto flex w-[1250px] flex-col items-center">
            
            {/* <div className=""> */}

              <h1 className="text-[45px] font-normal tracking-[-1px] text-[#222] text-center">About Us</h1>

              <p className="mt-7 max-w-[850px] text-center text-[18px] leading-8 text-[#666]">
              ...
              <svg className="w-16 h-16 text-[#50659b]" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <p className="mt-4 max-w-[250px] text-[17px] leading-7 text-[#666] text-center">
              ...
              <div className="flex w-[300px] flex-col items-center">
              <svg className="w-16 h-16 text-[#50659b]" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" aria-labelledby="title" aria-describedby="desc" role="img">
              ...
              <div className="flex w-[300px] flex-col items-center">
              <svg className="w-16 h-16 text-[#50659b]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" aria-labelledby="title" aria-describedby="desc" role="img">
