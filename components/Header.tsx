...
function Header() {
  ...
  return (
    ...
    <div className='fixed z-50 bg-white w-full h-[12.56%] pt-10 space-x-20 pl-20 items-center text-center'>
      <Link href="/" className='hover:cursor-pointer space-x-70'>Junk B Gone - Junk Removal Service</Link>&nbsp;
